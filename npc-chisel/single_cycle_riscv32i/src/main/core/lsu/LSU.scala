...
class LSUIO extends Bundle {
    val dmem = Flipped(new AXI_liteWithoutClk)
...
class LSU extends Module {
    ...
    switch(io_pipe.in.bits.exe2ls_mem_op) {
        is(0.U) {
            wstrb := MuxLookup(io_pipe.in.bits.exe2ls_alu_out(1,0), 0.U)(Seq(
                0.U   ->   1.U,
                1.U   ->   2.U,
                2.U   ->   4.U,
                3.U   ->   8.U
    ...
    switch(io_pipe.in.bits.exe2ls_mem_op) {
        is(0.U) {
            dmem_rdata_processed := MuxLookup(io_pipe.in.bits.exe2ls_alu_out(1,0), 0.U)(Seq(
                0.U   ->   Cat(Fill(24, io.dmem.rdata(7)), io.dmem.rdata(7,0)),
                1.U   ->   Cat(Fill(24, io.dmem.rdata(15)), io.dmem.rdata(15,8)),
                2.U   ->   Cat(Fill(24, io.dmem.rdata(23)), io.dmem.rdata(23,16)),
                3.U   ->   Cat(Fill(24, io.dmem.rdata(31)), io.dmem.rdata(31,24))
            ))
        }
        is(1.U) {
            dmem_rdata_processed := MuxLookup(io_pipe.in.bits.exe2ls_alu_out(1,0), 0.U)(Seq(
                0.U   ->   Cat(Fill(16, io.dmem.rdata(15)), io.dmem.rdata(15,0)),
                1.U   ->   Cat(Fill(16, io.dmem.rdata(15)), io.dmem.rdata(15,0)),
                2.U   ->   Cat(Fill(16, io.dmem.rdata(31)), io.dmem.rdata(31,16)),
                3.U   ->   Cat(Fill(16, io.dmem.rdata(31)), io.dmem.rdata(31,16))
            ))
        }
        is(2.U) {
            dmem_rdata_processed := io.dmem.rdata
        }
        is(4.U) {
            dmem_rdata_processed := MuxLookup(io_pipe.in.bits.exe2ls_alu_out(1,0), 0.U)(Seq(
                0.U   ->   Cat(Fill(24, 0.U), io.dmem.rdata(7,0)),
                1.U   ->   Cat(Fill(24, 0.U), io.dmem.rdata(15,8)),
                2.U   ->   Cat(Fill(24, 0.U), io.dmem.rdata(23,16)),
                3.U   ->   Cat(Fill(24, 0.U), io.dmem.rdata(31,24))
            ))
        }
        is(5.U) {
            dmem_rdata_processed := MuxLookup(io_pipe.in.bits.exe2ls_alu_out(1,0), 0.U)(Seq(
                0.U   ->   Cat(Fill(16, 0.U), io.dmem.rdata(15,0)),
                1.U   ->   Cat(Fill(16, 0.U), io.dmem.rdata(15,0)),
                2.U   ->   Cat(Fill(16, 0.U), io.dmem.rdata(31,16)),
                3.U   ->   Cat(Fill(16, 0.U), io.dmem.rdata(31,16))
            ))
        }
    }
    ...
    wdata := io_pipe.in.bits.exe2ls_rs2_data
